...
class CUB_200_2011(Dataset):
    def __init__(self, args, partition='train', pretrain=True, is_sample=False, k=4096,
        ...
        if self.pretrain:
            self.file_pattern = 'CUB_200_2011_category_split_train_phase_%s.pickle'
        else:
            self.file_pattern = 'CUB_200_2011_category_split_%s.pickle'
...
class MetaCUB_200_2011(CUB_200_2011):

    def __init__(self, args, partition='train', train_transform=None, test_transform=None, fix_seed=True):
        super(MetaCUB_200_2011, self).__init__(args, partition, False)
...
if __name__ == '__main__':
    ...
    imagenet = CUB_200_2011(args, 'train')
    print(len(imagenet))
    print(imagenet.__getitem__(500)[0].shape)

    metaimagenet = MetaCUB_200_2011(args)
