...
class Power80(Dataset):
    def __init__(self, args, partition='train', pretrain=True, is_sample=False, k=4096,
        ...
        if self.pretrain:
            self.file_pattern = 'Power_2023_80_category_split_train_phase_%s.pickle'
        else:
            self.file_pattern = 'Power_2023_80_category_split_%s.pickle'
        self.data = {}
...
class MetaPower100(Power100):
    
    def __init__(self, args, partition='train', train_transform=None, test_transform=None, fix_seed=True):
        super(MetaPower80, self).__init__(args, partition, False)
