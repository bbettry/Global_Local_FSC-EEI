...
class CustomizedLinear(nn.Module):
    def __init__(self, input_features, output_features, bias=True, mask=0.8):
        """
        Argumens
        ------------------
        mask [numpy.array]:
...
class ConvNet(nn.Module):
    ...
    def __init__(self, num_classes=-1):
        ...
        self.pro1 = Block(320, 320, stride=1)
        self.pro2 = Block(320,320, stride=1)
        ...
        self.conv2 = nn.Conv2d(256, 320, kernel_size=1, stride=1, padding=0, bias=False)
